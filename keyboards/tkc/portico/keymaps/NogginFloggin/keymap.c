...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        KC_TAB,     KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS, LT(3, KC_INS),
        LT(2, KC_CAPS),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,           KC_ENT, KC_PGUP,
        KC_LSFT,             KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,   KC_UP,  KC_PGDN,
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                               LT(1, KC_APP), KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______,  EF_INC,  EF_DEC,  BR_INC,  BR_DEC,  H1_INC,  H1_DEC,  S1_INC,  S1_DEC, _______, KC_PSCR, KC_SLCK, KC_PAUS,   RESET, KC_MUTE,
        KC_RCTL, _______, _______, _______, _______,  H2_INC,  H2_DEC,  S2_INC,  S2_DEC, _______, _______, _______,          0x5cde, KC_HOME,
        KC_LSFT,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_VOLU, KC_END,
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        KC_RCTL, RGB_SPI, RGB_SPD, _______, _______, _______, _______, _______, _______, _______, _______, _______,          0x5cde, KC_HOME,
        KC_LSFT,          _______, _______, _______, _______, _______, NK_TOGG, _______, _______, _______, _______, _______, KC_VOLU, KC_END,
        _______, _______, _______,                            _______,                            _______, _______, KC_MPRV, KC_VOLD, KC_MNXT
    ),
#endif
    [2] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, KC_MS_U, _______, _______, _______, _______, KC_P4, KC_P5, KC_P6, _______, KC_PENT, _______, _______, _______,
        _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, KC_P1, KC_P2, KC_P3, KC_PPLS, KC_PAST,          _______, _______,
        _______,          KC_MS_BTN1, KC_MS_BTN3, KC_MS_BTN2, _______, _______, _______, KC_P0, KC_PDOT, KC_PMNS, _______, _______, _______, _______,
