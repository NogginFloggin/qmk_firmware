...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, KC_UP, _______, _______, _______, _______, KC_P4, KC_P5, KC_P6, _______, KC_PENT, _______, _______, _______,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_P1, KC_P2, KC_P3, KC_PPLS, KC_PAST,          _______, _______,
        _______,          _______, _______, _______, _______, _______, _______, KC_P0, KC_PDOT, KC_PMNS, _______, _______, _______, _______,
